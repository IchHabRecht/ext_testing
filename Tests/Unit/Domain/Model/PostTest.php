...
/**
 * Test case for class \IchHabRecht\ExtTesting\Domain\Model\Post.
 *
...
{
	/**
	 * @var \IchHabRecht\ExtTesting\Domain\Model\Post
	 */
	protected $subject = NULL;

	public function setUp()
	{
		$this->subject = new \IchHabRecht\ExtTesting\Domain\Model\Post();
	}
	...
	{
		$authorFixture = new \IchHabRecht\ExtTesting\Domain\Model\Author();
	...
	{
		$tag = new \IchHabRecht\ExtTesting\Domain\Model\Tag();
	...
	{
		$comment = new \IchHabRecht\ExtTesting\Domain\Model\Comment();
